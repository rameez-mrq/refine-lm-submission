...
class CustomBERTModel(nn.Module):
	def __init__(self, k, batch_size):
		...
		self.tokenizer = DistilBertTokenizer.from_pretrained("distilbert-base-uncased", return_token_type_ids=False)
		self.distilbert = DistilBertForMaskedLM.from_pretrained("distilbert-base-uncased", output_hidden_states=True)
		self.topk = k
